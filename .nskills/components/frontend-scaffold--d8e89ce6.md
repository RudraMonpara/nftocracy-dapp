...
> Create a full NFT-based voting DApp frontend.
> 
> Requirements:
> 
> 1. Connect wallet using RainbowKit
> 
> 2. Show user NFT balance:
>    - Display token ID 1 and token ID 2 balances
> 
> 3. Proposal Section:
>    - Display all proposals from contract
>    - Show:
>      - description
>      - vote count
>      - deadline
> 
> 4. Create Proposal UI:
>    - Input: description
>    - Input: duration
>    - Button: Create Proposal (calls createProposal)
> 
> 5. Voting UI:
>    - Button: Vote
>    - Calls vote(proposalId)
> 
> 6. Show voting power:
>    - Call getVotingPower(user address)
> 
> 7. Disable vote button if:
>    - user already voted
>    - deadline passed
> 
...
> 
> 9. Use ethers.js or wagmi for contract interaction
> 
> 10. Clean UI using Tailwind:
>    - Cards for proposals
>    - Dashboard layout
> 
> Connect frontend to deployed ERC-1155 voting contract.
...
| `NEXT_PUBLIC_APP_NAME` | Application name displayed in wallet dialogs | No | No | NFTocracy |
...
**Depends on:**
- Erc1155-stylus (`477fa7ff`)

**Provides to:**
- Wallet-auth (`a92d4098`)
